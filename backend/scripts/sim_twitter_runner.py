"""
Twitter platform simulation runner.
"""
...
import wonderwall
from wonderwall import ActionType, LLMAction, ManualAction, generate_twitter_agent_graph
...
from sim_constants import TWITTER_ACTIONS
from sim_db_fetch import fetch_new_actions_from_db


class PlatformSimulation:
    """Lightweight result container for a completed platform simulation."""
    def __init__(self):
        self.env = None
...
async def run_twitter_simulation(
    ...
    """Run the Twitter simulation loop and return a PlatformSimulation."""
